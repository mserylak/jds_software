...
int main(int argc, char *argv[], char *arge[]) {
   ...
   if (argc < 2 || (strcmp(argv[1], "-h") == 0)) { /* in case there is a -h switch */
      ...
      puts("The program will write out header content from an UTR-2 jds file.");
      puts("Available parameters are:\n");
      puts("-a   Write out raw header parameters");
   ...
   start_MJD = gregjd(jy, jm, jd, (double)jhr, (double)jmn, jsc)-2400000.5; /* convert the date to Modified Julian Day */
